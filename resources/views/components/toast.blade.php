    ...
    <ul 
        ...
        <template x-for="(toast, index) in toasts" :key="toast.id">
            <li
                ...
                >
                <span 
                    class="relative flex flex-col items-start w-full max-w-xs transition-all duration-300 ease-out bg-white dark:bg-zinc-700/50 border rounded-md border-zinc-200 dark:border-zinc-700 group"
                    :class="{ 'p-4' : !toast.html, 'p-0' : toast.html }"
                >
                    <template x-if="!toast.html">
                        <div class="relative">
                            <div class="flex items-center"
                                :class="{ 'text-green-600 dark:text-green-400' : toast.type=='success', 'text-blue-500' : toast.type=='info', 'text-orange-400' : toast.type=='warning', 'text-red-500' : toast.type=='danger', 'text-gray-800' : toast.type=='default' }">
                                ...
                                <p class="text-sm font-semibold leading-none dark:text-white" x-text="toast.message"></p>
                            </div>
                            <p x-show="toast.description" 
                                :class="{ 'pl-5' : toast.type!='default' }"
                                class="mt-1.5 text-xs leading-none dark:text-white" x-text="toast.description"></p>
                        </div>
                    </template>
                    <template x-if="toast.html">
