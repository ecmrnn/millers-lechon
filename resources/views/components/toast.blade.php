<div x-cloak x-data="{ open : false, toast_details: {} }" x-init="
        ...
        x-on:toast.window="toast_details = JSON.parse($event.detail);
        ...
        <ul
            ...
            <template x-for="(toast, index) in toasts" :key="toast.id">
                <li
                    ...
                    >
                    <span
                        class="relative flex flex-col items-start shadow-sm dark:shadow-none dark:text-white w-full transition-all duration-300 ease-out bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 sm:rounded-md sm:max-w-xs group"
                    ...
                    >
                        <template x-if="!toast.html">
                            <div class="relative">
                                ...
                                <p x-show="toast.description"
                                    ...
                                    class="mt-1.5 text-xs leading-none opacity-70 dark:text-white" x-text="toast.description"></p>
                            </div>
                        </template>
                        <template x-if="toast.html">
                        ...
                        <span
                            ...
                            class="absolute right-0 p-1.5 mr-2.5 duration-100 ease-in-out rounded-full opacity-0 cursor-pointer bg-transparent hover:bg-zinc-800/5 dark:hover:bg-white/15 text-zinc-400 hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-white"
